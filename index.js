...
registerBtn.onclick = function (e) {
  ...
  registerForm.reset("");
  closeBtn.click();
  alert("Page Auto Refreash.");  // Display an alert

    // Define a function to refresh the page after a specified time
    ...
    // Call the autoRefresh function with a delay of 3000 milliseconds (3 seconds)
    autoRefresh(500);  // Refresh the page after 3 seconds (you can adjust the time)
...
function regitrationData() {
  userData.push({
    ...
    profilePic: imgUrl == undefined ? "User-1.png" : imgUrl
  });
  var userString = JSON.stringify(userData);
  localStorage.setItem("userData", userString);
  swal("Good job!", "Registration Succes!", "success");
}
    ...
    tableData.innerHTML += `
        ...
        <tr index='${index}'>
            ...
            <td>
                ...
                <button class="del-btn" style="background-color: rgb(196, 55, 55);"><i class="fa fa-trash"></i></button>
            </td>
        <tr>
        `;
  });
...
var searchEl = document.querySelectorAll("#empId");
